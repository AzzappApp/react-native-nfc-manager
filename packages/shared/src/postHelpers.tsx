 ...
 */
export const POST_IMAGES_SIZES = [128, 256, 512, 1024, 1536];

/**
 * the list of possible post videos pregenerated sizes
 */
export const POST_VIDEO_SIZES = [128, 256, 512, 768, 1024, 1280];
