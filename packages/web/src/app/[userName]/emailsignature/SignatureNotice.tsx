...
const MobileIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      d="M6.75 2.5H18.75C19.3023 2.5 19.75 2.94772 19.75 3.5V21.5C19.75 22.0523 19.3023 22.5 18.75 22.5H6.75C6.19772 22.5 5.75 22.0523 5.75 21.5V3.5C5.75 2.94772 6.19772 2.5 6.75 2.5ZM12.75 17.5C12.1977 17.5 11.75 17.9477 11.75 18.5C11.75 19.0523 12.1977 19.5 12.75 19.5C13.3023 19.5 13.75 19.0523 13.75 18.5C13.75 17.9477 13.3023 17.5 12.75 17.5Z"
      fill="currentColor"
    />
  </svg>
);
