...
class ColorLUTFilter: Filter<ColorLUTFilter.Parameters> {
  ...
  override fun draw(parameters: Parameters, glFramePool: GLFramePool, frameBufferPool: FrameBufferPool): GLFrame {
    ...
    val lutImage = parameters.lutImage
    ...
    val uColorLutSampler = glProgram.getUniformLocation("uColorLutSampler")
    GLES20.glActiveTexture(GLES20.GL_TEXTURE1)
    GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, lutImage.texture)
    GLES20.glUniform1i(uColorLutSampler, 1)
