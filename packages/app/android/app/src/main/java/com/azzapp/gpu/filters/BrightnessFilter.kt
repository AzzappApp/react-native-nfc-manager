...
class BrightnessFilter: Filter<BrightnessFilter.Parameters> {
  ...
  override fun draw(parameters: Parameters, glFramePool: GLFramePool, frameBufferPool: FrameBufferPool): GLFrame {
    ...
    var uTintColor = glProgram.getUniformLocation("brightness")
    GLES20.glUniform1f(uTintColor, brightness)
  ...
  companion object {
    ...
    private val FRAGMENT_SHADER = """
      ...
      void main() {
        ...
        gl_FragColor = vec4((texColor.rgb + vec3(brightness)), texColor.w);
      }
    """.trimIndent()
  }
}
