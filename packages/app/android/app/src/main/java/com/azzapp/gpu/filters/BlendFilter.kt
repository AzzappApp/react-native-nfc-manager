...
class BlendFilter: Filter<BlendFilter.Parameters> {
  ...
  override fun draw(parameters: Parameters, glFramePool: GLFramePool, frameBufferPool: FrameBufferPool): GLFrame {
    ...
    val maskImage = parameters.maskImage
    ...
    var uMaskTexSampler = glProgram.getUniformLocation("uMaskTexSampler")
    GLES20.glActiveTexture(GLES20.GL_TEXTURE1)
    GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, maskImage.texture)
    GLES20.glUniform1i(uMaskTexSampler, 1)
