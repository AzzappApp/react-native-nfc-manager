import { Canvas, ImageSVG, Mask, Rect, Skia } from '@shopify/react-native-skia';
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Rect x={0} y={0} width={136} height={28} color={skiaColor} />
        </Mask>
      </Canvas>
    </>
  );
...
const svg = Skia.SVG.MakeFromString(`
  <svg width="136" height="28" viewBox="0 0 136 28">
    <path
      fill="currentColor"
    ...
    <Header
      middleElement={
        <AnimatedHomeHeaderCentralComponent
          isPremium={!!currentWebCard?.isPremium}
