// TODO reenable this test once we finish the implementation
...
//         Query: () => ({
//           webCardCategories: range(0, 10).map(i => ({
//             id: `webCardCategory-${i}`,
//             webCardKind: i % 2 === 0 ? 'personal' : 'business',
...
//       const webCardKindButtons = screen.queryAllByRole('togglebutton');

//       expect(webCardKindButtons[0]).toHaveAccessibilityState(
...
//       act(() => {
//         fireEvent.press(webCardKindButtons[1]);
//       });
...
//       expect(webCardKindButtons[1]).toHaveAccessibilityState(
//         expect.objectContaining({ checked: true }),
//       );
...
//   const renderToProfileForm = (webCardKind: 'business' | 'personal') => {
//     renderNewProfileScreen();
//     if (webCardKind === 'business') {
//       act(() => {
...
//           lastName: 'Doe',
//           userName: 'johndoe',
//           webCardCategoryId: 'webCardCategory-0',
...
//           companyName: 'Azzapp',
//           userName: 'azzapp',
//           webCardCategoryId: 'webCardCategory-1',
