...
//  azzapp
//
//  Created by François de Campredon on 10/04/2023.
//
...
extension UIColor {
  ...
  public convenience init?(stringRepresentation colorStr: String) {
    var hexColor: String;
    if let hex = UIColor.allColors[colorStr]  {
      hexColor = hex
    } else if colorStr.hasPrefix("#") {
      hexColor = String(colorStr.dropFirst())
