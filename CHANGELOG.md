...
* **fix:**  - reduce number of refresh with memo ([#8355](https://github.com/AzzappApp/azzapp/pull/8355))
...
* **fix:**  - update imagePicker buttons centering method to allow clinking on background images ([#8034](https://github.com/AzzappApp/azzapp/pull/8034))
* **fix:**  - allow popup text line 1 to be on 2 lines ([#8033](https://github.com/AzzappApp/azzapp/pull/8033))
* **fix:**  - cleanup email generated by AI ([#8035](https://github.com/AzzappApp/azzapp/pull/8035))
...
* **fix:**  - **multiUser:** [#7939](https://github.com/AzzappApp/azzapp/pull/7939) isPremium flag in logo ([#7943](https://github.com/AzzappApp/azzapp/pull/7943))
* **fix:**  - try to fix display issue in share screen ([#7941](https://github.com/AzzappApp/azzapp/pull/7941))
...
* **fix:**  - add robustness on missing image width/height
...
* **fix:**  - be less restrictive on props
* **fix:**  - logo item is not correctly restored in contact card edition
