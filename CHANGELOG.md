...
* **fix:**  - 🐛 properly use filename in local path ([#6343](https://github.com/AzzappApp/azzapp/pull/6343))
* **fix:**  - fix offline qrcode displayed ([#6342](https://github.com/AzzappApp/azzapp/pull/6342))
* **fix:**  - 🐛 avoid crash from invalid number in cover link edition ([#6338](https://github.com/AzzappApp/azzapp/pull/6338))
* **fix:**  - **mediaPicker:** [#5084](https://github.com/AzzappApp/azzapp/pull/5084) simplify refresh case ([#6313](https://github.com/AzzappApp/azzapp/pull/6313))
* **fix:**  - **android:** [#6287](https://github.com/AzzappApp/azzapp/pull/6287) reduce margin bottom to see labels ([#6317](https://github.com/AzzappApp/azzapp/pull/6317))
* **fix:**  - **CoverEdition:** Animation preview duration
* **fix:**  - **HomeScreen:** simplify index synchronisation ([#6321](https://github.com/AzzappApp/azzapp/pull/6321))
* **fix:**  - add margin top to allow cross access ([#6268](https://github.com/AzzappApp/azzapp/pull/6268))
* **fix:**  - **multiUser:** [#6189](https://github.com/AzzappApp/azzapp/pull/6189) use list for long list of info ([#6315](https://github.com/AzzappApp/azzapp/pull/6315))
...
* **feat:**  - some rework on appclip to use param url directly instead of the full azzap url. add some text on the background to help debug un real case ([#6283](https://github.com/AzzappApp/azzapp/pull/6283))
...
* **fix:**  - add bottom inset to color picker height ([#6278](https://github.com/AzzappApp/azzapp/pull/6278))
...
* **fix:**  - 🐛 change mmkv store on auth change ([#6279](https://github.com/AzzappApp/azzapp/pull/6279))
* **fix:**  - **Android:** buffer loader issues
...
* **fix:**  - **CoverEdition:** crash with pexel images
...
* **fix:**  - use texture in video decoding/encoding ([#6267](https://github.com/AzzappApp/azzapp/pull/6267))
