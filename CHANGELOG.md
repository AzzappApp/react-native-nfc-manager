...
* **fix:**  - ensure form validation is not needed to manage contactCard avatar ([#7529](https://github.com/AzzappApp/azzapp/pull/7529))
...
* **feat:**  - fetch logo and create cover ([#7491](https://github.com/AzzappApp/azzapp/pull/7491))
...
* **fix:**  - avoid blink while leaving edit mode
